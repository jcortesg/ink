  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved agent as @agent" do
        ...
        post :create, {:agent => { "addres" => "invalid value" }}, valid_session
        assigns(:agent).should be_a_new(Agent)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested agent" do
        ...
        Agent.any_instance.should_receive(:update_attributes).with({ "addres" => "MyString" })
        put :update, {:id => agent.to_param, :agent => { "addres" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the agent as @agent" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Agent.any_instance.stub(:save).and_return(false)
        put :update, {:id => agent.to_param, :agent => { "addres" => "invalid value" }}, valid_session
        assigns(:agent).should eq(agent)
      end
